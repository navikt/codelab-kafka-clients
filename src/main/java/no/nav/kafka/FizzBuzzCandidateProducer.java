...
public class FizzBuzzCandidateProducer {
    ...
    public static void main(String[] args) {
        ...
        IntStream.range(1, 11).forEach(n -> {
            final Integer fizzBuzzCandidate = new Random().nextInt(100);

            final ProducerRecord<String, Integer> record = new ProducerRecord<>("FizzBuzzNumberEntered", fizzBuzzCandidate);
